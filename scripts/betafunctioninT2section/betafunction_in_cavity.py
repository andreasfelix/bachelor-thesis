...
betamin = np.array([0.63, 3.37, 1.2, 3.60])
...
plt.legend(iter(lineObjects), ('min: 0.63 m', 'max: 3.37 m', 'current betay: 1.28 m', 'V4 betay: 3.60 m'))
...
plt.savefig("../../images/04-betafunction_in_cavity.pdf", transparent=True)
# plt.show()
