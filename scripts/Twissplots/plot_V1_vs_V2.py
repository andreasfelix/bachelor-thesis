...
latticelist = [os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V1/V1.lte",
               os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V2/V2_2017-05-14_15-42-32.lte",
               os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V3/V3_2017-05-14_15-45-23.lte",
               os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V4/V4_2017-05-14_15-55-33.lte",
               os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V5/V5_2017-05-14_05-17-07.lte"]
...
# reference lattice
reflatticepath = os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V1/V1.lte"
reflatticedata = returnlatticedata(reflatticepath, 'felix_full')
reftwissdata = returntwissdata(reflatticedata)

# plot
activelattice = latticelist[1]
...
plt.annotate("V2 vs V1", xy=(0.98, height_1), xycoords='figure fraction', va='center', ha='right', fontsize=fs, weight='bold')
...
plt.savefig("../../images/05-V1_vs_V2.pdf")
