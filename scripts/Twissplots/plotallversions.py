...
latticelist = [os.path.expanduser("~") + "/git/element/output/FITQ5T2/V1/V1.lte",
               os.path.expanduser("~") + "/git/element/output/FITQ5T2/V2/V2_2017-05-14_15-42-32.lte",
               os.path.expanduser("~") + "/git/element/output/FITQ5T2/V3/V3_2017-05-14_15-45-23.lte",
               os.path.expanduser("~") + "/git/element/output/FITQ5T2/V4/V4_2017-05-14_15-55-33.lte",
               os.path.expanduser("~") + "/git/element/output/FITQ5T2/V5/V5_2017-05-14_05-17-07.lte"]

latticenamelist = ["V1", "V2", "V3", "V4", "V5"]
...
# reference lattice
reflatticepath = os.path.expanduser("~") + "/git/element/lattices/BII_2017-03-28_17-54_LOCOFitByPS_noID_ActualUserMode_third_best.lte"
...
for i in range(5):
    ...
    annolist_string = "$Q_x$: {:.2f} ({:.0f} kHz)   $Q_x$: {:.2f} ({:.0f} kHz)   $\\alpha_C$: {:.2e}".format(twissdata.Qx, twissdata.QxFreq, twissdata.Qy, twissdata.QyFreq, twissdata.alphac)
    ...
    plt.savefig("../../images/Overview-all-solutions/" + latticenamelist[i] + "-comparison.pdf")
