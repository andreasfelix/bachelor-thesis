...
def plot(XY, anno=True):
    ...
    paintlattice(0, latticedata.LatticeLength, latticedata, -1e3 * ylim, +1e3 * ylim, noborder=False, halfsize=True, fs=15)
...
activelattice = expanduser("~") + '/git/element/lattices/Newtracking/DBA.lte'
...
activelattice2 = expanduser("~") + "/git/element/lattices/BII_2016-06-10_user_Sym_noID_DesignLattice1996.lte"
...
paintlattice(15, 30, latticedata_linear, ylim_min, ylim_max, noborder=False, halfsize=True, fs=15)
...
plt.tight_layout()
plt.savefig("../../images/04-design-DBA_andern.pdf")
