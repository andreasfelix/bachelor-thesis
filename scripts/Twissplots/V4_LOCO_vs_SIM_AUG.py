...
# reference lattice
reflatticepath = os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V4-04-08-2017/V4-new-04-08_2017-08-05_02-05-01.lte"
...
plt.annotate("V4 LOCO vs V4 SIM (AUG)", xy=(0.98, height_1), xycoords='figure fraction', va='center', ha='right', fontsize=fs, weight='bold')
...
plt.savefig("../../images/Overview-all-solutions/A-V4_LOCO_vs_SIM_AUG.pdf")
