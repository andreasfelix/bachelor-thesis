...
# reference lattice
reflatticepath = os.path.expanduser("~") + "/git/element/lattices/Q5T2off/SIM/V4/V4_2017-05-14_15-55-33.lte"
reflatticedata = returnlatticedata(reflatticepath, 'felix_full')
reftwissdata = returntwissdata(reflatticedata)

# plot
activelattice = os.path.expanduser("~") + "/git/element/lattices/Q5T2off/LOCO/BII_2017-05-17_01-43_LOCOFitByPS_noID_O5T2_off_V4_13_iterations_newmodel.lte"
...
plt.annotate("V4 LOCO vs V4 SIM (MAY)", xy=(0.98, height_1), xycoords='figure fraction', va='center', ha='right', fontsize=fs, weight='bold')
...
plt.savefig("../../images/05-V4_LOCO_vs_SIM.pdf")
